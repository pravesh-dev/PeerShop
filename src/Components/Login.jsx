  ...
  return (
    <div className='w-full h-screen bg-[#111] flex justify-center items-center'>
      <div className='bg-[#0000004b] w-80 h-[30rem] mx-1  flex gap-5 flex-col items-center justify-center border border-white/20 rounded-sm md:w-[30rem] lg:mt-14'>
        <h1 className='text-2xl font-krona'>LOGIN</h1>
        ...
        <p className='text-sm tracking-widest'>Don't have an account? <Link className='text-[#7B4CFF] tracking-normal font-bold'>Create New</Link></p>
      </div>
    </div>
  )
}
