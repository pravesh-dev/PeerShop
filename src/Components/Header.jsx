    ...
    <>
      ...
      <div className="w-full py-5 px-3 flex items-center justify-between fixed top-0 left-0 z-[98] lg:px-12 lg:py-6 bg-gradient-to-t from-transparent to-black backdrop-blur-sm">
        ...
        <div className="flex items-center gap-3 lg:gap-7">
          ...
          <Link to='/login' className="hidden lg:block bg-white text-black w-24 py-1 rounded-md text-center font-bold border duration-300 hover:bg-transparent hover:text-white">Login</Link>
        </div>
      </div>
    </>
  );
